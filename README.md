...
***
***
This is an experimental branch used for toying with C++17 features. It is likely
to be scrapped and may break at any time. Development is currently done with
clang++ built from svn checkouts at random points in time. You have been warned.
***
***
